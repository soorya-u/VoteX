const Mission = () => {
  return (
    <section className="provide-world our_mission pt-120 pb-120 relative z-0">
      <div className="animation absolute top-0 left-0 w-full h-full -z-[1]">
        <img
          src="assets/images/vector8.png"
          alt="vector"
          className="absolute bottom-0 pt-6 pt-xl-15 hidden d-lg-flex push_animat"
        />
      </div>
      <div className="container">
        <div className="row justify-content-between items-center mb-10 mb-lg-15">
