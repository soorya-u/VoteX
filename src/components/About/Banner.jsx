...
const Banner = () => {
  return (
    <section className="bg-banner bg-no-repeat bg-center bg-cover pt-[50px] sm:pt-[60px] lg:pt-[120px] pb-[50px] sm:pb-[60px] lg:pb-[120px]">
      <div className="w-full px-3 mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px] lg:mt-0 pt-18 xl:pt-20">
          ...
          <div className="flex-[0_0_auto] w-full">
            ...
            <nav aria-label="breadcrumb">
              <ol className="gap-y-2 mb-0">
                <li>
                  <Link
                    className="text-base lg:text-[18px] font-[500]"
                    href="/"
                  >
                    Home
                  </Link>
                ...
                <li
                  ...
                  aria-current="page"
                >
                  <span className="text-[#fff6e9]">About Us</span>
                </li>
              </ol>
            </nav>
          </div>
