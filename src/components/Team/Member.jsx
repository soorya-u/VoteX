...
const Member = ({
  ...
  return (
    <section className="team pt-120 pb-120 relative z-0">
      <div className="container">
        <div className="row gy-6">
          ...
          <div className="col-12 mt-10 mt-lg-15 flex justify-center">
            <Link
              href="/"
              className="cmn-btn py-2 py-lg-3 px-4 px-lg-6 gap-2 gap-lg-3 items-center"
            >
              View More
            </Link>
          </div>
